...
nPractice = 5
nMain = 10
# Run 'Before Experiment' code from code_pract
...
IC_img = visual.ImageStim(
    win=win,
    name='IC_img', 
    image='informed_consent.png', mask=None, anchor='center',
...
instr_image = visual.ImageStim(
    ...
    image='instructFrame1.png', mask=None, anchor='center',
...
frame1 = visual.Rect(
    win=win, name='frame1',units='height', 
...
frame2 = visual.Rect(
    win=win, name='frame2',units='height', 
    width=(0.45, 0.45)[0], height=(0.45, 0.45)[1],
    ori=0.0, pos=(0,0), anchor='center',
    lineWidth=2.0,     colorSpace='rgb',  lineColor='white', fillColor=[0.0000, 0.0000, 0.0000],
    opacity=1.0, depth=-2.0, interpolate=True)
frame3 = visual.Rect(
    win=win, name='frame3',units='height', 
    width=(0.45, 0.45)[0], height=(0.45, 0.45)[1],
    ori=0.0, pos=(0.5, 0), anchor='center',
    lineWidth=2.0,     colorSpace='rgb',  lineColor='white', fillColor=[0.0000, 0.0000, 0.0000],
...
for thisPracticeTrial in practiceTrials:
    ...
    while continueRoutine:
        ...
        if frame1.status == STARTED:  # only update if drawing
            frame1.setOpacity(0.0, log=False)
        ...
        if frame2.status == STARTED:  # only update if drawing
            frame2.setOpacity(0.0, log=False)
        ...
        if frame3.status == STARTED:  # only update if drawing
            frame3.setOpacity(0.0, log=False)
